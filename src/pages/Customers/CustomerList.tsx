...
import { Plus, Search, Edit, Trash2, Users, FileSpreadsheet } from 'lucide-react';
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {loading ? (
                      ...
                      <tr key={customer.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(customer.credit_limit)}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <button onClick={() => navigate(`/customers/${customer.id}/edit`)} className="text-primary hover:text-primary-hover mr-4" type="button" aria-label="Edit customer">
                            <Edit className="h-4 w-4" />
                          </button>
                          <button onClick={() => handleDelete(customer.id)} className="text-red-600 hover:text-red-900" type="button" aria-label="Delete customer">
